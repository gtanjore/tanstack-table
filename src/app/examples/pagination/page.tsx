...
function MyTable({
  ...
  return (
    <>
      <div className="margin-205 width-desktop">
        <div className="width-full">
          <input
            className="usa-input width-full radius-pill shadow-4"
            placeholder="Search..."
            value={filtering}
        ...
        <div>
        <table className="usa-table usa-table--striped shadow-4 radius-lg">
          <thead>
